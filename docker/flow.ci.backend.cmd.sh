...
/flyway/flyway -user=$MYSQL_USER -password=$MYSQL_PASSWORD -baselineOnMigrate=true -locations=filesystem:$MIGRATION_PATH -url=jdbc:mysql://db:3306/flow_api_db migrate
